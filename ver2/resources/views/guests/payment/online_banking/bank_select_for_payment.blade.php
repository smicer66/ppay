            ...
            <form action="/api/login-to-pay" id="loginToPayForm" method="post" enctype="application/x-www-form-urlencoded">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="col-xs-12 col-sm-12" style="cursor: pointer">
                        <div style="text-align: right !Important; font-weight: bold !important">{{$currency}}{{number_format($total, 2, '.', ',')}}</div>

                        <div class="row gap-20">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group" style="padding-top:10px !important">
                                    <label style="font-weight: 100 !important">Select a bank to proceed</label>
                                    <div class="input-group  col col-md-12 col-sm-12 col-xs-12 col-lg-12" style="background-color: #EBEBEB; padding-right: 0px !Important">
                                        <div class="col col-md-2 col-sm-2 col-xs-2 col-lg-2" style="text-align: center !Important; padding-top: 5px !Important; padding-left: 0px !Important">+260</div>
                                        <div class="col col-md-10 col-sm-10 col-xs-10 col-lg-10" style="padding-right: 0px !Important">
                                            <select id="bank" name="bank" required class="form-control " style="
                                               opacity: .8;
                                               cursor: text;
                                    ...
                                    <div class="input-group  col col-md-12 col-sm-12 col-xs-12 col-lg-12" style="padding-top: 10px !Important; padding-left: 0px !Important; padding-right: 0px !Important">
                                        <a href="javascript:loginToPay()" class="btn btn-primary mt-15 col-md-12 col-lg-12 col-sm-12 col-xs-12" name="submitButton" value="Create Account">Login To Pay <i class="fa fas fa-angle-double-right"></i></a>
    <!--<input type="submit">-->
                                    </div>
