                        ...
                        <div class="row gap-20">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group" style="padding-top:10px !important">
                                    <h4>Complete Your Tokenization</h4>
                                    ...
                                    <div class="input-group  col col-md-12 col-sm-12 col-xs-12 col-lg-12" style="padding-top: 10px !Important; padding-left: 0px !Important; padding-right: 0px !Important">
                                        <a href="javascript:validateOTPToPay()" class="btn btn-primary mt-15 col-md-12 col-lg-12 col-sm-12 col-xs-12" name="submitButton" id="validateOTPToPay" value="Validate OTP To Tokenize">Complete Tokenization <i class="fa fas fa-angle-double-right"></i></a>
                                        <!--<input type="submit">-->
                                    </div>
...
function validateOTPToPay()
{
    ...
    var url = '/api/otp-to-confirm-tokenization';
					...
					success: function handleSuccess(data1){
						...
						if(data1.success===true)
						{
							...
							if(data1.status==100)
							{
								...
								returnResp['listing'] = data1.listing;
								returnResp['orderId'] = data1.orderId;
								returnResp['return_url'] = data1.return_url;
								returnResp['auto_return_to_merchant'] = true;
								@if($billData!=null && isset($billData['scope']) && $billData['scope']!=null)
									returnResp['scope'] = '{{$billData['scope']}}';
								@endif
							...
							else
							{
								...
								toggleLoading();
								loginToPayLinkCount++;
								$('#loginToPayLink').html('Complete Tokenization <i class="fa fas fa-angle-double-right"></i>');
								...
								$(document).ready(function(){
									...
									url = '/ajax-tokenization-fail.html/{{TOKENIZATION_FAIL_PAGE}}/{{$input}}';
									if(testMode==0)
									{
										setTimeout(function(){
