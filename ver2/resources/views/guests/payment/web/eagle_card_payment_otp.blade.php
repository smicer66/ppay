            ...
            border: 1px solid rgba(0,0,0,.24); -webkit-box-shadow: 0 1px 21px rgba(0,0,0,.17); box-shadow: 0 1px 21px rgba(0,0,0,.17);">
                ...
                <div style="padding-top:15px;padding-bottom:15px;">
                    ...
                    <div class="col col-md-10">
                        <strong>{{$payerName}}<br>
                        <span style="font-size:20px;">ZMW{{number_format($amt, 2, '.', ',')}}</span></strong>
                    </div>
                </div>
                    ...
                    <form action="/payments/process-web-eagle-process-otp" method="post" enctype="application/x-www-form-urlencoded">
                        <div>
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="otp" style="font-weight: 300;
                                       display: block;
                                       color: #888;
                                       letter-spacing: .5px;
                                       font-size: 14px;
                                       ...
                                       z-index: 50000;" placeholder="Enter OTP">
                            </div>
                        </div>
                        ...
                        <div style="padding:0px !important;">
                            <div class="col col-md-12" style="padding:0px;">
                                <input type="submit" class="form-control btn btn-primary col col-md-12" style="padding:10px; font-size:12px; font-weight:500" name="submit" value="Proceed">
                            </div>
                        </div>
                ...
                <div class="col col-md-12">
                    <table class="table table-hover col col-md-12" style="font-size:12px" id="paytable">
                        ...
                        <tr class="table-info" style="font-weight: bold">
                            ...
                            <td class="col col-md-4"><div style="text-align: right">{{number_format($amt, 2, '.', ',')}}</div></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
