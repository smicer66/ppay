                            ...
                            <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="example2"
                                            rowspan="1" colspan="1"
                                            aria-label="Engine version: activate to sort column ascending">Channel</th>
                                        @endif
...
if($x==1)
{
    ...
    //dd($transaction);
                                    ...
                                    <tr role="row" class="{{$x++%2==0 ? 'even' : 'odd'}}">
                                        ...
                                        <td>
                                            @if(isset($transaction->account) && isset($transaction->creditAccountTrue) &&
                                                ...
                                                {{"CR: ".$transaction->account->accountIdentifier}}{{$transaction->creditAccountTrue}}
                                            @endif
                                            @if(isset($transaction->account) && isset($transaction->creditAccountTrue) &&
                                        ...
                                        @endif
                                        @if(!isset($channel))
                                        <td class="sorting_1">{{$transaction->channel}}</td>
                                        @endif
                                        ...
                                        <td>
                                            @if(isset($transaction->creditAccountTrue) &&
                                                $transaction->creditAccountTrue!=NULL && $transaction->creditAccountTrue===true)
                                                {{"CR: ".number_format($actualAmount, 2, '.', ',')}}
                                            @elseif(isset($transaction->creditAccountTrue) &&
                                                $transaction->creditAccountTrue!=NULL && $transaction->creditAccountTrue===false)
                                                {{"DR: ".number_format($actualAmount, 2, '.', ',')}}
                                            @else
                                    ...
                                    <tr role="row" class="odd">
                                        <td colspan="{{(\Auth::user()->role_code != \App\Models\Roles::$MERCHANT) ? 7 : 5}}"><strong>Total</strong></td>
                                        <td>
