<div id="transferCardWrapper" class="allfloater col col-md-6" style="padding-top:30px;display: none; background: rgba(0,0,0,0.55); top: 0%; position: fixed; z-index:10000; height:100%;width:100%">
...
filter: alpha(opacity=100); width:80%; display:block;">
		<div class="modal-header" style="background-color: #000 !important; color: #fff !important">
			<button type="button" class="close" onclick="javascript:hidenewcard('transferCardWrapper')" aria-label="Close">
				<span aria-hidden="true">×</span></button>
			<h4 class="modal-title" id="modal-title">Transfer Card</h4>
		</div>
		<div class="modal-body" style="background-color: #fff !important; height:80% !important; overflow-y: scroll">
			...
			<div class="box-body">
				<label for="inputEmail3" class="col-sm-6 control-label" style="padding-left: 0px !important"><strong>Customer Name:</strong> <div id="transferCardCustomerName" class="" style="font-weight: 100 !important;"></div></label>
				
				<label for="inputEmail3" class="col-sm-6 control-label pull-right" style="text-align:right !important; padding-left: 0px !important"><strong>Account Number:</strong> <div id="transferCardAccountNumber" class="" style="font-weight: 100 !important;"></div></label>
				...
				<div class="col-sm-12" style="padding-left: 0px !important">
                    ...
                    <div class="form-group col-md-5" id="cardTypeNewCardDiv" style="padding-left: 0px !important">
                        ...
                        <div class="col-sm-6" id="transferCardCardPan">
					...
					<div class="form-group col-md-5 pull-right" id="nameOnNewCardDiv" style="padding-right: 0px !important">
                        ...
                        <div class="col-sm-6 pull-right" style="padding-right: 0px !important" id="transferCardCardType">
                    ...
                    <div class="form-group col-md-5" id="cardSchemeNewCardDiv" style="padding-left: 0px !important">
                        ...
                        <div class="col-sm-6" id="transferCardCardScheme">
					...
					<div class="form-group col-md-5 pull-right" id="nameOnNewCardDiv" style="padding-right: 0px !important">
                        ...
                        <div class="col-sm-6 pull-right" style="padding-right: 0px !important" id="transferCardCardSerialNo">
                            
                        </div>
                    </div>
                    <div class="form-group col-md-5" style="padding-left: 0px !important" id="">
                        <label for="inputEmail3" class="col-sm-5 control-label" style="padding-left: 0px !important">New Card Tracking No:</label>
		...
		<div class="modal-footer" style="background-color: #000 !important; color: #fff !important">
			...
			<a style="cursor:hand" class="btn btn-success" id="transferCardSubmit">Transfer Card</a>
		</div>
	</div>
