<div id="customerAccountWrapper" class="allfloater col col-md-6" style="padding-top:30px;display: none; background: rgba(0,0,0,0.55); top: 0%; position: fixed; z-index:10000; height:100%;width:100%">
...
filter: alpha(opacity=100); width:80%; display:block;">
		<div class="modal-header" style="background-color: #000 !important; color: #fff !important">
			...
			<h4 class="modal-title" id="modal-title">Customer Accounts</h4>
		</div>
		<div class="modal-body" style="background-color: #fff !important; height:80% !important; overflow-y: scroll">
			...
			<div class="box-body">
				<label for="inputEmail3" class="col-sm-6 control-label" style="padding-left: 0px !important"><strong>Customer Name:</strong> <div id="customername" class=""></div></label>
				
				<label for="inputEmail3" class="col-sm-6 control-label pull-right" style="text-align:right !important; padding-left: 0px !important"><strong>Customer Verification Number:</strong> <div id="customerverficationnumber" class=""></div></label>
				
				<div class="col-sm-12" style="padding-left: 0px !important">
					<hr>
					<table id="customeraccounttable" class="display" style="width:100%">
						<thead>
							<tr role="row">
		...
		<div class="modal-footer" style="background-color: #000 !important; color: #fff !important">
			...
			<a style="cursor:hand" class="btn btn-primary" id="customerAccountsAddAccount">Add New Account</a>
		</div>
	</div>
