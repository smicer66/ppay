							...
							<div class="element-box">
								...
								<div class="col-md-9" style="">
									...
									<div class="table-responsive">
										<div>
											<div style="background-color: #c7c7c7  !important; padding: 10px !important; display: inline-block; color: #1b13ba !important; font-weight: bold !important;">MTN</div>
										</div>
										<table id="walletinfotable" width="100%" class="table table-striped table-lightfont" style="clear: both !important">
											<tbody>
												...
												<tr>
													<td style="padding: 10px !important; font-weight: bold !important">MSISDN Credited:</td >
													<td style="padding: 10px !important; text-align: right !important">{{explode('~', $transaction->transactionDetail)[4]}}</td>
												</tr>
												<tr style="background-color: #c7c7c7;">
													<td style="padding: 10px !important; font-weight: bold !important">Wallet/Card Debited:</td >
													<td style="padding: 10px !important; text-align: right !important">{{$transaction->debitAccountIdentifier}}</td>
												</tr>
												<tr>
												...
												<tr style="background-color: #c7c7c7;">
													<td style="padding: 10px !important; font-weight: bold !important">Balance Before Debit ({{array_keys($currencies)[$transaction->probasePayCurrency]}}):</td >
													<td style="padding: 10px !important; text-align: right !important">{{number_format($transaction->priorAccountBalance, 2, '.', ',')}}</td>
												</tr>
												<tr>
													<td style="padding: 10px !important; font-weight: bold !important">Balance After Debit ({{array_keys($currencies)[$transaction->probasePayCurrency]}}):</td>
													<td style="padding: 10px !important; text-align: right !important">{{number_format($transaction->currentAccountBalance, 2, '.', ',')}}</th>
												</tr>
											</tbody>
										</table>
										<div>
