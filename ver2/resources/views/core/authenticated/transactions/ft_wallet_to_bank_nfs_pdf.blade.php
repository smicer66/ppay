...
?>
										...
										<table id="walletinfotable" width="100%" class="table table-striped table-lightfont" style="clear: both !important">
											<tbody>
												<tr>
													<td style="padding: 10px !important; font-weight: bold !important">Transfer Date:</td>
												...
												<tr>
													<td style="padding: 10px !important; font-weight: bold !important">Account/Card Credited:</td >
												...
												<tr style="background-color: #c7c7c7;">
													...
													<td style="padding: 10px !important; text-align: right !important">{{isset($transaction->debitAccountIdentifier) && !is_null($transaction->debitAccountIdentifier) ? $transaction->debitAccountIdentifier : (isset($transaction->debitPan) && !is_null($transaction->debitPan) ? $transaction->debitPan: "")}}</td>
												</tr>
												<tr>
