            ...
            <form class="form-horizontal" autocomplete="off" action="/potzr-staff/merchants/new-merchant-step-three" method="post" enctype="application/x-www-form-urlencoded">
                <div class="box-body">
                    ...
                    @if($all_device_types->$deviceType=='WEB')
						...
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-3 control-label">ZICB UAT Auth Key</label>

							<div class="col-sm-9">
								<input type="text" value="{{\Input::old('zicbAuthKeyuat') ? \Input::old('zicbAuthKeyuat') : ''}}" placeholder="Provide a valid ZICB UAT Auth key if you have one" name="zicbAuthKeyuat" class="form-control" id="zicbAuthKeyuat">
							</div>
						</div>
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-3 control-label">ZICB UAT Service Key</label>

							<div class="col-sm-9">
								<input type="text" value="{{\Input::old('zicbServiceKeyuat') ? \Input::old('zicbServiceKeyuat') : ''}}" placeholder="Provide a valid ZICB UAT Service key if you have one" name="zicbServiceKeyuat" class="form-control" id="zicbServiceKeyuat">
							</div>
						</div>
                    @endif
