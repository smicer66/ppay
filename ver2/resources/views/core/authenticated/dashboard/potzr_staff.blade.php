		...
		<div class="row">
                <div class="col-sm-12 col-xxxl-12">
                  <div class="element-wrapper">
                    ...
                    <div class="element-box" style="background-color: transparent !important; box-shadow: none !important; border-left: 0px !important; border-right: 0px !important; border-bottom: 0px !important">
                      <div class="table-responsive col-md-2 col-xxx1-2" style="float: left !important">
                        <div class="profile-tile abc">
                    		<a class="profile-tile-box" href="/potzr-staff/logs/BALANCE_INQUIRY">
                      		<div class="pt-avatar-w">
                        			<i class="fa fa-file" style="color: blue !important;"></i>
                      		</div>
                      ...
                      <div class="table-responsive col-md-2 col-xxx1-2" style="float: left !important">
                        <div class="profile-tile abc">
                    		<a class="profile-tile-box" href="/potzr-staff/logs/REMOTE_DEBIT">
                      		<div class="pt-avatar-w">
                        			<i class="fa fa-file" style="color: blue !important;"></i>
                      		</div>
                      		<div class="pt-user-name">
                      ...
                      <div class="table-responsive col-md-2 col-xxx1-2" style="float: left !important">
                        <div class="profile-tile abc">
                    		<a class="profile-tile-box" href="/potzr-staff/logs/CREATE_VIRTUAL_CARD">
                      		<div class="pt-avatar-w">
                        			<i class="fa fa-file" style="color: blue !important;"></i>
                      		</div>
                      		<div class="pt-user-name">
                        			Create Virtual Card Log
                      		</div>
                    		</a>
			    </div>
                      </div>
                      ...
                      <div class="table-responsive col-md-2 col-xxx1-2" style="float: left !important">
                        <div class="profile-tile abc">
                    		<a class="profile-tile-box" href="/potzr-staff/logs/ACTIVATE_CARD">
                      		<div class="pt-avatar-w">
                        			<i class="fa fa-file" style="color: blue !important;"></i>
                      		</div>
                      		<div class="pt-user-name">
                      ...
                      <div class="table-responsive col-md-2 col-xxx1-2" style="float: left !important">
                        <div class="profile-tile abc">
                    		<a class="profile-tile-box" href="/potzr-staff/logs/CHANGE_CARD_PIN">
                      		<div class="pt-avatar-w">
                        			<i class="fa fa-file" style="color: blue !important;"></i>
                      		</div>
                      		<div class="pt-user-name">
                      ...
                      <div class="table-responsive col-md-2 col-xxx1-2" style="float: left !important">
                        <div class="profile-tile abc">
                    		<a class="profile-tile-box" href="/potzr-staff/logs/CREATE_QR_DATA">
                      		<div class="pt-avatar-w">
                        			<i class="fa fa-file" style="color: blue !important;"></i>
                      		</div>
                      		<div class="pt-user-name">
			...
			<div style="clear: both !important">&nbsp;</div>
                      ...
                      <div class="table-responsive col-md-2 col-xxx1-2" style="float: left !important">
                        <div class="profile-tile abc">
                    		<a class="profile-tile-box" href="/potzr-staff/logs/DEACTIVATE_QR_DATA">
                      		<div class="pt-avatar-w">
                        			<i class="fa fa-file" style="color: blue !important;"></i>
                      		</div>
                      		<div class="pt-user-name">
                        			Deactivate QR Data Log
                      		</div>
                    		</a>
			    </div>
                      </div>
                      ...
                      <div class="table-responsive col-md-2 col-xxx1-2" style="float: left !important">
                        <div class="profile-tile abc">
                    		<a class="profile-tile-box" href="/potzr-staff/logs/DEDUCT_ADJUSTMENT">
                      		<div class="pt-avatar-w">
                        			<i class="fa fa-file" style="color: blue !important;"></i>
                      		</div>
                      		<div class="pt-user-name">
                        			Deduct Adjustment Log
                      		</div>
                    		</a>
			    </div>
                      </div>
                      ...
                      <div class="table-responsive col-md-2 col-xxx1-2" style="float: left !important">
                        <div class="profile-tile abc">
                    		<a class="profile-tile-box" href="/potzr-staff/logs/DEDUCT_REVERSAL_LOG">
                      		<div class="pt-avatar-w">
                        			<i class="fa fa-file" style="color: blue !important;"></i>
                      		</div>
                      		<div class="pt-user-name">
                      ...
                      <div class="table-responsive col-md-2 col-xxx1-2" style="float: left !important">
                        <div class="profile-tile abc">
                    		<a class="profile-tile-box" href="/potzr-staff/logs/GET_CUSTOMER__ACTIVE_CARDS">
                      		<div class="pt-avatar-w">
                        			<i class="fa fa-file" style="color: blue !important;"></i>
                      		</div>
                      		<div class="pt-user-name">
                        			Get Customer Active Cards
                      		</div>
                    		</a>
			    </div>
                      </div>
                      ...
                      <div class="table-responsive col-md-2 col-xxx1-2" style="float: left !important">
                        <div class="profile-tile abc">
                    		<a class="profile-tile-box" href="/potzr-staff/logs/GET_CARD_STATUS">
                      		<div class="pt-avatar-w">
                        			<i class="fa fa-file" style="color: blue !important;"></i>
                      		</div>
                      		<div class="pt-user-name">
                      ...
                      <div class="table-responsive col-md-2 col-xxx1-2" style="float: left !important">
                        <div class="profile-tile abc">
                    		<a class="profile-tile-box" href="/potzr-staff/logs/LOAD_AUTH">
                      		<div class="pt-avatar-w">
                        			<i class="fa fa-file" style="color: blue !important;"></i>
                      		</div>
                      		<div class="pt-user-name">
			...
			<div style="clear: both !important">&nbsp;</div>
                      ...
                      <div class="table-responsive col-md-2 col-xxx1-2" style="float: left !important">
                        <div class="profile-tile abc">
                    		<a class="profile-tile-box" href="/potzr-staff/logs/LOAD_AUTH_REVERSAL">
                      		<div class="pt-avatar-w">
                        			<i class="fa fa-file" style="color: blue !important;"></i>
                      		</div>
                      		<div class="pt-user-name">
                        			Load Auth Reversal Log
                      		</div>
                    		</a>
			    </div>
                      </div>
                      ...
                      <div class="table-responsive col-md-2 col-xxx1-2" style="float: left !important">
                        <div class="profile-tile abc">
                    		<a class="profile-tile-box" href="/potzr-staff/logs/LOAD_MPQR">
                      		<div class="pt-avatar-w">
                        			<i class="fa fa-file" style="color: blue !important;"></i>
                      		</div>
                      		<div class="pt-user-name">
                        			Load MPQR Wallet Log
                      		</div>
                    		</a>
			    </div>
                      </div>
                      ...
                      <div class="table-responsive col-md-2 col-xxx1-2" style="float: left !important">
                        <div class="profile-tile abc">
                    		<a class="profile-tile-box" href="/potzr-staff/logs/LOAD_MPQR_REVERSAL">
                      		<div class="pt-avatar-w">
                        			<i class="fa fa-file" style="color: blue !important;"></i>
                      		</div>
                      		<div class="pt-user-name">
                        			Load MPQR Reversal Log
                      		</div>
                    		</a>
			    </div>
                      </div>
                      ...
                      <div class="table-responsive col-md-2 col-xxx1-2" style="float: left !important">
                        <div class="profile-tile abc">
                    		<a class="profile-tile-box" href="/potzr-staff/logs/LINK_CUSTOMER_TO_CARD">
                      		<div class="pt-avatar-w">
                        			<i class="fa fa-file" style="color: blue !important;"></i>
                      		</div>
                      		<div class="pt-user-name">
                      ...
                      <div class="table-responsive col-md-2 col-xxx1-2" style="float: left !important">
                        <div class="profile-tile abc">
                    		<a class="profile-tile-box" href="/potzr-staff/logs/LOAD_ADJUSTMENT">
                      		<div class="pt-avatar-w">
                        			<i class="fa fa-file" style="color: blue !important;"></i>
                      		</div>
                      		<div class="pt-user-name">
                      ...
                      <div class="table-responsive col-md-2 col-xxx1-2" style="float: left !important">
                        <div class="profile-tile abc">
                    		<a class="profile-tile-box" href="/potzr-staff/logs/LOAD_ADJUSTMENT_REVERSAL">
                      		<div class="pt-avatar-w">
                        			<i class="fa fa-file" style="color: blue !important;"></i>
                      		</div>
                      		<div class="pt-user-name">
                        			Load Adjust Reversal Log
                      		</div>
                    		</a>
			    </div>
                      </div>
			...
			<div style="clear: both !important">&nbsp;</div>
                      ...
                      <div class="table-responsive col-md-2 col-xxx1-2" style="float: left !important">
                        <div class="profile-tile abc">
                    		<a class="profile-tile-box" href="/potzr-staff/logs/SERVER_RESTART">
                      		<div class="pt-avatar-w">
                        			<i class="fa fa-file" style="color: blue !important;"></i>
                      		</div>
                      		<div class="pt-user-name">
                      ...
                      <div class="table-responsive col-md-2 col-xxx1-2" style="float: left !important">
                        <div class="profile-tile abc">
                    		<a class="profile-tile-box" href="/potzr-staff/logs/ORDER_NEW_CARD">
                      		<div class="pt-avatar-w">
                        			<i class="fa fa-file" style="color: blue !important;"></i>
                      		</div>
                      		<div class="pt-user-name">
                      ...
                      <div class="table-responsive col-md-2 col-xxx1-2" style="float: left !important">
                        <div class="profile-tile abc">
                    		<a class="profile-tile-box" href="/potzr-staff/logs/RETIRE_CARD">
                      		<div class="pt-avatar-w">
                        			<i class="fa fa-file" style="color: blue !important;"></i>
                      		</div>
                      		<div class="pt-user-name">
                      ...
                      <div class="table-responsive col-md-2 col-xxx1-2" style="float: left !important">
                        <div class="profile-tile abc">
                    		<a class="profile-tile-box" href="/potzr-staff/logs/STOP_CARD_REMOTE">
                      		<div class="pt-avatar-w">
                        			<i class="fa fa-file" style="color: blue !important;"></i>
                      		</div>
                      		<div class="pt-user-name">
                        			Stop Card Log (Remote)
                      		</div>
                    		</a>
			    </div>
                      </div>
                      ...
                      <div class="table-responsive col-md-2 col-xxx1-2" style="float: left !important">
                        <div class="profile-tile abc">
                    		<a class="profile-tile-box" href="/potzr-staff/logs/STOP_CARD_LOCAL">
                      		<div class="pt-avatar-w">
                        			<i class="fa fa-file" style="color: blue !important;"></i>
                      		</div>
                      		<div class="pt-user-name">
                      ...
                      <div class="table-responsive col-md-2 col-xxx1-2" style="float: left !important">
                        <div class="profile-tile abc">
                    		<a class="profile-tile-box" href="/potzr-staff/logs/TRANSFER_CARD">
                      		<div class="pt-avatar-w">
                        			<i class="fa fa-file" style="color: blue !important;"></i>
                      		</div>
                      		<div class="pt-user-name">
			...
			<div style="clear: both !important">&nbsp;</div>
                      ...
                      <div class="table-responsive col-md-2 col-xxx1-2" style="float: left !important">
                        <div class="profile-tile abc">
                    		<a class="profile-tile-box" href="/potzr-staff/logs/UNSTOP_CARD">
                      		<div class="pt-avatar-w">
                        			<i class="fa fa-file" style="color: blue !important;"></i>
                      		</div>
                      		<div class="pt-user-name">
                      ...
                      <div class="table-responsive col-md-2 col-xxx1-2" style="float: left !important">
                        <div class="profile-tile abc">
                    		<a class="profile-tile-box" href="/potzr-staff/logs/CHANGE_CARD_BEARER">
                      		<div class="pt-avatar-w">
                        			<i class="fa fa-file" style="color: blue !important;"></i>
                      		</div>
                      		<div class="pt-user-name">
                        			Change Card Bearer Log
                      		</div>
                    		</a>
			    </div>
                      </div>
                      ...
                      <div class="table-responsive col-md-2 col-xxx1-2" style="float: left !important">
                        <div class="profile-tile abc">
                    		<a class="profile-tile-box" href="/potzr-staff/logs/CHANGE_CARD_CVV">
                      		<div class="pt-avatar-w">
                        			<i class="fa fa-file" style="color: blue !important;"></i>
                      		</div>
                      		<div class="pt-user-name">
                      ...
                      <div class="table-responsive col-md-2 col-xxx1-2" style="float: left !important">
                        <div class="profile-tile abc">
                    		<a class="profile-tile-box" href="/potzr-staff/logs/FUNDS_TRANSFER">
                      		<div class="pt-avatar-w">
                        			<i class="fa fa-file" style="color: blue !important;"></i>
                      		</div>
                      		<div class="pt-user-name">
                      ...
                      <div class="table-responsive col-md-2 col-xxx1-2" style="float: left !important">
                        <div class="profile-tile abc">
                    		<a class="profile-tile-box" href="/potzr-staff/logs/PAY_BILLS">
                      		<div class="pt-avatar-w">
                        			<i class="fa fa-file" style="color: blue !important;"></i>
                      		</div>
                      		<div class="pt-user-name">
                      ...
                      <div class="table-responsive col-md-2 col-xxx1-2" style="float: left !important">
                        <div class="profile-tile abc">
                    		<a class="profile-tile-box" href="/potzr-staff/logs/USER_SIGNUP">
                      		<div class="pt-avatar-w">
                        			<i class="fa fa-file" style="color: blue !important;"></i>
                      		</div>
                      		<div class="pt-user-name">
			...
			<div class="table-responsive col-md-2 col-xxx1-2" style="float: left !important">
                        <div class="profile-tile abc">
                    		<a class="profile-tile-box" href="/potzr-staff/logs/SMS_SEND">
                      		<div class="pt-avatar-w">
                        			<i class="fa fa-file" style="color: blue !important;"></i>
                      		</div>
                      		<div class="pt-user-name">
			...
			<div class="table-responsive col-md-2 col-xxx1-2" style="float: left !important">
                        <div class="profile-tile abc">
                    		<a class="profile-tile-box" href="/potzr-staff/logs/EMAIL_SEND">
                      		<div class="pt-avatar-w">
                        			<i class="fa fa-file" style="color: blue !important;"></i>
                      		</div>
                      		<div class="pt-user-name">
			...
			<a class="btn btn-white btn-sm" href="/potzr-staff/end-of-day"><i class="os-icon os-icon-clock"></i><span>Run End Of Day</span></a>
			@if(\Auth::user()->role_code=='POTZR_STAFF')
			<a class="btn btn-white btn-sm" href="#"><i class="os-icon os-icon-user"></i><span>Customer Issues</span></a>
			<a class="btn btn-white btn-sm" href="/potzr-staff/shutdown-server"><i class="os-icon os-icon-server"></i><span>Shutdown Server</span></a>
			@endif
                  </div>
                </div>
              </div>
              ...
              START - Tickets
              -------------------->
              <div class="element-wrapper" id="supportmessagelisting">
                ...
                <div class="element-box-tp">
                  ...
                  <div class="users-list-w">
                    <div class="user-w with-status status-green">
                      ...
                      <a class="user-action" href="/potzr-staff/logs/sdsad">
