                                ...
                                @if($accounts!=null && sizeof($accounts)>0)
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12 col-xs-12 col-lg-12" style="text-align: right !important">
                                            <div class="">
                                                <a style="cursor: pointer !important" class="btn btn-success pull-right" onclick="handleAddNewCard('{{$accountIdentifier}}', '{{\Session::get('jwt_token')}}', event, 'newWalletForm')">Create My Card</a>
                                            </div>
                                        </div>
                                    </div>
                                @else
        ...
        <div class="content-w">
            <div class="content-i">
                <div class="content-box">
                                    ...
                                    <div class="element-balances">
                                        <div class="balance hidden-mobile">
                                            ...
                                            <div class="balance-value">
                                                <span id="overViewCardsFundInCards">0.00</span>
                                            </div>
                                        ...
                                        <div class="balance">
                                            ...
                                            <div class="balance-value" id="overViewCardsAvailableFundsInWallet">
                                                0.00
                                            </div>
                                            <div class="balance-link">
                                        ...
                                        <div class="balance">
                                            ...
                                            <div class="balance-value success" id="overViewCardsTodaysBill">
                                                $180
                                            </div>
                                            <div class="balance-link">
                    ...
                    <div class="row">
                        <!--<div class="col-lg-12 col-xxl-12 col-md-12 col-sm-12 col-xs-12" style="padding-left: 0px !Important; padding-right:0px !important;">
                            <div class="element-wrapper" style="padding-left: 0px !Important; padding-right:0px !important;">
                                <div class="element-box" style="padding-left: 0px !Important; padding-right:0px !important; background-color: transparent !important; box-shadow: none !important;">
                                    <img src="/img/bevura_mastercard.png" class="col-lg-4 col-md-4 col-xs-3 col-sm-4">
                                    <div style="position: relative; bottom: 150px; color: #fff !important; left: 50px; font-size: 25px;">1234&nbsp;&nbsp;5678&nbsp;&nbsp;9123&nbsp;&nbsp;9123</div>
                                    <div style="position: relative; bottom: 10px; color: #fff !important;">Card Holder</div>
                                    <div style="position: relative; bottom: 10px; color: #fff !important;">John Doe</div>
                                </div>
                            </div>
                        </div>-->
                        <div class="col-lg-12 col-xxl-12 col-md-12 col-sm-12 col-xs-12" style='padding-left: 0px !Important; padding-right:0px !important; font-family: "Helvetica Neue", Helvetica, sans-serif; padding: 10px'>

                            @foreach($cards as $card)
                            <div class="col col-lg-4 col-md-4 col-xs-3 col-sm-4" style="padding: 10px !important;
                                ...
                                ">
                                    <div class="col col-md-12 col-sm-12 col-xs-12 col-lg-12" style="">
                                        <div class="col col-md-8 col-sm-8 col-xs-8 col-lg-8" style="
                                            padding-top: 50px !important;
                                            padding-left: 20px !important;
                                            float: left !important;
                                        ">
                                            <img src="/img/bevura_logo.png" class="col-md-6">
                                        </div>
                                        <div class="col col-md-4 col-sm-4 col-xs-4 col-lg-4" style="
                                            padding-top: 50px !important;
                                            padding-left: 20px !important;
                                            float: left !important;
                                            ...
                                            font-size: 20px;
                                        ">
                                            <strong style="font-weight: bold !important"><small>{{$accounts[0]->currencyCode}}</small>{{number_format($card->cardBalance, 2, '.', ',')}}</strong>
                                        </div>
                                        <div class="cardFont emboss number" style="
                                            ...
                                            letter-spacing: 5px;
                                        ">
                                            {{join(' ', str_split($card->pan, 4))}}
                                        </div>
                                        <div class="col col-md-10 col-sm-10 col-xs-10 col-lg-10" style="float: left !important">
                                            <div class="cardFont" style="
                                        ...
                                        <div class="col col-md-2 col-sm-2 col-xs-2 col-lg-2" style="padding: 0px !important; padding-top: 30px !important;
                                                padding-left: 20px !important; float: right !important">
                                            <img src="/img/mastercard_logo.png" class="col-md-12 pull-right" style="padding: 0px !important; float: right !important;">
                                        </div>
                                        <div class="col col-md-12 col-sm-12 col-xs-12 col-lg-12" style="clear: both !important; padding: 10px !important;">&nbsp;</div>
                                    </div>
                                </div>
                            </div>
                            @endforeach
                        ...
                        <div class="element-box-tp">
                            <div class="table-responsive">
                                <table class="table table-padded">
                                    ...
                                    <tr>
                                        <td class="nowrap">
                                            <span class="status-pill smaller green"></span><span>{{ucfirst(strtolower($transactionStatuses[$transaction->status]))}}</span>
                                        </td>
                                        <td>
                                            <span>{{date('M d, Y', strtotime($transaction->created_at))}}</span><span class="smaller lighter">{{date('g:i:s A', strtotime($transaction->created_at))}}</span>
                                        </td>
                                        <td class="cell-with-media">
                                            <small><span>{{$transaction->transactionDetail}}</span></small>
                                        </td>
                                        <td class="text-center">
                                            @if($serviceTypesKeys[$transaction->serviceType]=='DEPOSIT_OTC')
                                                <a class="badge badge-success" href="">
                                            @elseif($serviceTypesKeys[$transaction->serviceType]=='PAY_MERCHANT')
                                                <a class="badge badge-danger" href="">
                                            @elseif($serviceTypesKeys[$transaction->serviceType]=='DEBIT_MERCHANT')
                                                <a class="badge badge-success" href="">
                                            @elseif($serviceTypesKeys[$transaction->serviceType]=='REVERSE_PAYMENT_TO_MERCHANT')
                                                <a class="badge badge-danger" href="">
                                            @elseif($serviceTypesKeys[$transaction->serviceType]=='DEBIT_CARD')
                                                <a class="badge badge-danger" href="">
                                            @elseif($serviceTypesKeys[$transaction->serviceType]=='DEBIT_WALLET')
                                                <a class="badge badge-danger" href="">
                                            @elseif($serviceTypesKeys[$transaction->serviceType]=='CASHBACK')
                                                <a class="badge badge-success" href="">
                                            @elseif($serviceTypesKeys[$transaction->serviceType]=='ADJUSTMENT')
                                                <a class="badge badge-success" href="">
                                            @elseif($serviceTypesKeys[$transaction->serviceType]=='CREDIT_CARD')
                                                <a class="badge badge-success" href="">
                                            @elseif($serviceTypesKeys[$transaction->serviceType]=='REVERSE_DEBIT_ON_CARD')
                                                <a class="badge badge-danger" href="">
                                            @elseif($serviceTypesKeys[$transaction->serviceType]=='REVERSE_CREDIT_ON_CARD')
                                                <a class="badge badge-success" href="">
                                            @elseif($serviceTypesKeys[$transaction->serviceType]=='CASH_PAYMENT')
                                                <a class="badge badge-danger" href="">
                                            @elseif($serviceTypesKeys[$transaction->serviceType]=='REVERSE_REFUND')
                                                <a class="badge badge-danger" href="">
                                            @elseif($serviceTypesKeys[$transaction->serviceType]=='MPQR_WALLET_LOAD')
                                                <a class="badge badge-success" href="">
                                            @elseif($serviceTypesKeys[$transaction->serviceType]=='REVERSE_MPQR_WALLET_LOAD')
                                                <a class="badge badge-danger" href="">
                                            @endif
                                                {{$serviceTypes[$transaction->serviceType]}}</a>
                                        </td>
                                        <td class="text-right bolder nowrap">
                                            ...
                                            @elseif($serviceTypesKeys[$transaction->serviceType]=='REVERSE_MPQR_WALLET_LOAD')
                                                <span class="text-danger">-
                                            @endif
                                                {{number_format($transaction->amount, 2, '.', ',')}} {{$currencies[$transaction->probasePayCurrency]}}
                                            </span>
                                        </td>
                                    </tr>
                                    @endforeach
...
<script>
    $( document ).ready(function() {
        loadCardsOverview('{{\Session::get('jwt_token')}}', '{{$accountIdentifier}}');
    });
</script>
</body>
</html>
