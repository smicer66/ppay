  ...
  <div class="col-sm-12">
    <div class="element-wrapper">
      <div class="element-box">
          ...
          <div class="form-desc">
            Income Statement covers the transactions from inception
          </div>
          ...
          <div class="row">
			...
			<div style="clear: both !important">&nbsp;</div> 
					...
					$totalExpense = 0.00;
                                ?>
                                <tbody>
                                    @foreach($incomeGLList as $journalEntry)
					...
					<tfooter>
                                    <tr role="row" style="background-color: #000 !important; color: #fff !important; font-weight: bold !important;">
                                        <th class="sorting_asc" tabindex="0" aria-controls="example2"
                                            rowspan="1" colspan="1" aria-sort="ascending" width="15%"
                                            aria-label="Rendering engine: activate to sort column descending"><strong>TOTAL INCOME</strong></th>
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" width="10%"
                                            aria-label="CSS grade: activate to sort column ascending" style="text-align: right"><strong>&nbsp;</strong></th>
						<th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" width="10%"
                                            aria-label="CSS grade: activate to sort column ascending" style="text-align: right"><strong>{{number_format($totalIncome, 2, '.', ',')}}</strong></th>
                                    </tr>
                                </tfooter>
				</table>
		...
		<div class="row">
			...
			<div style="clear: both !important">&nbsp;</div> 
					...
					$totalExpense = 0.00;
                                ?>
                                <tbody>
                                    @foreach($expenseGLList as $journalEntry)
                                   <tr role="row" class="odd">
                                        <td><span style="color: #000 !important">{{$journalEntry->glAccountCode}}</i></span></td>
                                        <td style="text-align: left"><span style="color: #000 !important">{{$journalEntry->glAccountName}}</span></td>
                                        <td style="text-align: right"><span style="color: #000 !important">{{number_format($journalEntry->amount, 2, '.', ',')}}</span></td>
					...
					<tfooter>
                                    <tr role="row" style="background-color: #000 !important; color: #fff !important; font-weight: bold !important;">
                                        <th class="sorting_asc" tabindex="0" aria-controls="example2"
                                            rowspan="1" colspan="1" aria-sort="ascending" width="15%"
                                            aria-label="Rendering engine: activate to sort column descending"><strong>TOTAL EXPENSES</strong></th>
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" width="10%"
                                            aria-label="CSS grade: activate to sort column ascending" style="text-align: right"><strong>&nbsp;</strong></th>
						<th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" width="10%"
                                            aria-label="CSS grade: activate to sort column ascending" style="text-align: right"><strong>{{number_format($totalExpense, 2, '.', ',')}}</strong></th>
                                    </tr>
                                </tfooter>
					...
					<tfooter>
                                    <tr role="row" style="background-color: #000 !important; color: #fff !important; font-weight: bold !important;">
                                        <th class="sorting_asc" tabindex="0" aria-controls="example2"
                                            rowspan="1" colspan="1" aria-sort="ascending" width="15%"
                                            aria-label="Rendering engine: activate to sort column descending"><strong>NET INCOME</strong></th>
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" width="10%"
                                            aria-label="CSS grade: activate to sort column ascending" style="text-align: right"><strong>&nbsp;</strong></th>
						<th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" width="10%"
