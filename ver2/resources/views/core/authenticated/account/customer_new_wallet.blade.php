...
<div aria-hidden="true" class="onboarding-modal modal fade animated" role="dialog" tabindex="-1" id="customer_new_wallet_modal">
        ...
        <div class="modal-content text-center">
            ...
            <div style="padding: 60px 70px;">
                    <h2 style="margin-top: 0px;">
                        Your First Wallet or Card
                    </h2>
                    <div style="color: #636363; font-size: 14px;">
                        Hello {{\Auth::user()->firstName}}, provide the details in the form below to create a new wallet or card so that you can start transacting with convenience
                    </div>
