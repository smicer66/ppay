<div id="viewAccountCardsWrapper" class="allfloater col col-md-6" style="padding-top:30px;display: none; background: rgba(0,0,0,0.55); top: 0%; position: fixed; z-index:10000; height:100%;width:100%">
...
filter: alpha(opacity=100); width:90%; display:block;">
		<div class="modal-header" style="background-color: #000 !important; color: #fff !important">
			<button type="button" class="close" onclick="javascript:hidenewcard('viewAccountCardsWrapper')" aria-label="Close">
				<span aria-hidden="true">×</span></button>
			<h4 class="modal-title" id="modal-title">Cards Belonging To Account - <span id="viewAccountCustomerAccountNo"></span></h4>
		</div>
		<div class="modal-body" style="background-color: #fff !important; height:80% !important; overflow-y: scroll">
			...
			<div class="box-body">
				<label for="inputEmail3" class="col-sm-6 control-label" style="padding-left: 0px !important"><strong>Customer Name:</strong> <div id="accountCustomerName" class="" style="font-weight: 100 !important;"></div></label>
				
				<label for="inputEmail3" class="col-sm-6 control-label pull-right" style="text-align:right !important; padding-left: 0px !important"><strong>Customer Verification Number:</strong> <div id="accountCustomerverficationnumber" class="" style="font-weight: 100 !important;"></div></label>
				
				<div class="col-sm-12" style="padding-left: 0px !important">
					<hr>
					<table id="accountcardtable" class="display" style="width:100%">
						<thead>
							<tr role="row">
		...
		<div class="modal-footer" style="background-color: #000 !important; color: #fff !important">
			...
			<a style="cursor:hand" class="btn btn-primary" id="viewAccountCardsAddCard">Add Card</a>
		</div><!---->
	</div>
