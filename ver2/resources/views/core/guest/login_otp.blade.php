...
<div class="overlay">
    <div class="ui-panel login-panel animated bounceInDown">
        ...
        <form class="" method="post" id="login" action="/auth/pin-login">
            <div class="login-form" style="clear: both !important">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <input type="hidden" name="token" value="{{$token}}">
                <div class="subtitle"><strong>Enter your Secure 2FA Pin</strong></div>
            ...
            <footer style="padding-bottom: 50px !important;">
                ...
                <div class="right form-actions">
                    <a onclick="loginAction()" style="cursor: pointer !important;" class="ui-button inactive register">Confirm My Pin</a>
                </div>
            </footer>
        </form>
    </div>
