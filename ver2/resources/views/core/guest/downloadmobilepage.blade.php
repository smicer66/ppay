    ...
    <div class="reserve-box mt-30" style="position: relative !important; border: 0px double #EBE9E8; margin-bottom: 0px !important">
        ...
        <div style="clear: both !important; padding-left: 0px !important; padding-right: 0px !important" class="container-fluid invoice-container" id="section-to-print" style="margin-left:0px !important; margin-right: 0px !important;"> 				
					...
					<div class="col-xs-12 col-sm-12 col-lg-12 col-md-12" style="padding: 0px; padding-right: 10px; padding-top: 10px; ">
						...
						<h2 class="katamari-field" data-katamari-field-id="heading-1">Download on PlayStore</h2>
							<div class="row">
								<div class="col col-xs-12 col-md-6 col-sm-12 col-lg-4" style="padding-top: 20px !important">
									<div class="office">
										<h6 class="katamari-field" data-katamari-field-id="8" data-katamari-field-type="html">Android</h6>
										<a href="http://play.google.com" class="katamari-field" data-katamari-field-id="9"><div class="katamari-field address" data-katamari-field-id="99" data-katamari-field-type="html"><img src="/images/playstore.jpg" style="width: 200px !important"></div></a>
										<a href="http://play.google.com" class="katamari-field" data-katamari-field-id="9">play.google.com</a>
