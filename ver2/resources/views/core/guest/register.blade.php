<html lang="en" class="-webkit- wf-proximanova-n7-active wf-proximanova-i4-active wf-proximanova-n4-active wf-proximanova-i7-active wf-proximanova-n1-active wf-proximanova-n3-active wf-proximanova-n6-active wf-active"><head>
    ...
    <title>CodePen - Bananaplate Login Panel</title>
    ...
    <div class="ui-panel login-panel animated bounceInDown">
        <header>
            ...
            <div class="left logo" style="padding-top: 30px !important;">
                <img class="logo_image" src="http://creditcard.axiomthemes.com/wp-content/uploads/2017/07/main-logo.png" alt="" width="120"><br>
        ...
        <form class="" method="post" id="registerNewCustomer">
            <div class="login-form" style="clear: both !important; width: 40%; float: left !important; border-right: 1px solid #fff">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <div class="subtitle"><strong>Your Account Login Details</strong></div>
                ...
                <div style="float: right !important; width: 65% important">
                    <input type="text" name="mobileNumber" placeholder="Mobile Number">
                </div>
                <input type="password" name="password" placeholder="Password">
                <input type="password" name="confirmPassword" placeholder="Confirm Password">
            </div>
            <div class="login-form" style="width: 40%; float: left !important">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <div class="subtitle"><strong>Provide your Bio-Data</strong></div>
                <input type="text" name="firstName" placeholder="First Name">
                <input type="text" name="lastName" placeholder="Last Name">
                <input type="text" name="otherName" placeholder="Other Name">
            </div>

            <footer style="clear: both !important; padding-bottom: 50px !important;">
                <div class="left social-login">
                    <a href="#login" class="ui-button inactive login">Forgot Password</a>
                    <a href="#login" class="ui-button inactive login"> | Register</a>
                </div>

                <div class="right form-actions">
                    <a onclick="createNewCustomer('registerNewCustomer')" style="cursor: pointer !important;" class="ui-button inactive register">Create My Account</a>
                </div>
            </footer>
        </form>
    </div>
