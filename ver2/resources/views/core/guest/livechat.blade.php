...
<div class="holder" style="border: 0px solid #000">
    <div class="reserve-box mt-30" style="position: relative !important; border: 0px double #EBE9E8; margin-bottom: 0px !important">
        <div class="col-xs-12 col-sm-12 col-lg-12 col-md-12" style="text-transform: uppercase;
            ...
            <div style="float: right !important; text-align:right !Important; font-size: 11px !important; padding-right: 0px !important;" class="col col-md-7 col-sm-7 col-lg-7 col-xs-7"><small>FAQs</small></div>
        ...
        <div style="clear: both !important; padding-left: 0px !important; padding-right: 0px !important" class="container-fluid invoice-container" id="section-to-print" style="margin-left:0px !important; margin-right: 0px !important;"> 				
					...
					<div class="col-xs-12 col-sm-12 col-lg-12 col-md-12" style="padding: 0px; padding-right: 10px; padding-top: 10px; ">
						...
						<h2 class="katamari-field" data-katamari-field-id="heading-1">FAQs</h2>
							<div class="row">
								<div class="col col-xs-12 col-md-6 col-sm-12 col-lg-4" style="padding-top: 20px !important">
<div class="shadow-blocks__card-wrapper visible" has="help-center">
  <div class="shadow-blocks__card">
    <div class="shadow-blocks__card-content">
      <div>
      ...
      <ul>
            ...
            <li class="block-internal-list-item"><a href="/mobile-extension/coming-soon">How Do I Create A New Card?</a></li>
          
            <li class="block-internal-list-item"><a href="/mobile-extension/coming-soon">Whats A Physical & Virtual Card?</a></li>
          
            <li class="block-internal-list-item"><a href="/mobile-extension/coming-soon">How Do I Block My Card?</a></li>
          
            <li class="block-internal-list-item"><a href="/mobile-extension/coming-soon">How Do I Fund My Card?</a></li>
          
            <li class="block-internal-list-item"><a href="/mobile-extension/coming-soon">How Do I Get A Physical Card?</a></li>
  ...
  <div class="shadow-blocks__card">
    <div class="shadow-blocks__card-content">
      ...
      <ul>
            ...
            <li class="block-internal-list-item"><a href="/mobile-extension/coming-soon">My Transfer Receipient Was Not Successful</a></li>
          
            <li class="block-internal-list-item"><a href="/mobile-extension/coming-soon">Can I Transfer To A Bank Account?</a></li>
          
            <li class="block-internal-list-item"><a href="/mobile-extension/coming-soon">How Much Are The Charges For A Transfer?</a></li>
          
            <li class="block-internal-list-item"><a href="/mobile-extension/coming-soon">Can I Transfer To A Mobile Money Wallet?</a></li>
