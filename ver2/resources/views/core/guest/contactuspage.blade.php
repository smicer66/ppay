...
<div class="holder" style="border: 0px solid #000">
    <div class="reserve-box mt-30" style="position: relative !important; border: 0px double #EBE9E8; margin-bottom: 0px !important">
        <div class="col-xs-12 col-sm-12 col-lg-12 col-md-12" style="text-transform: uppercase;
            ...
            <div style="float: right !important; text-align:right !Important; font-size: 11px !important; padding-right: 0px !important;" class="col col-md-7 col-sm-7 col-lg-7 col-xs-7"><small>Where We Are</small></div>
        ...
        <div style="clear: both !important; padding-left: 0px !important; padding-right: 0px !important" class="container-fluid invoice-container" id="section-to-print" style="margin-left:0px !important; margin-right: 0px !important;"> 				
					...
					<div class="col-xs-12 col-sm-12 col-lg-12 col-md-12" style="padding: 0px; padding-right: 10px; padding-top: 10px; ">
						...
						<h2 class="katamari-field" data-katamari-field-id="heading-1">Where To Find Us</h2>
							<div class="row">
								<div class="col col-xs-12 col-md-6 col-sm-12 col-lg-4" style="padding-top: 20px !important">
									<div class="office">
										<h6 class="katamari-field" data-katamari-field-id="8" data-katamari-field-type="html">Lusaka</h6>
										<div class="katamari-field address" data-katamari-field-id="99" data-katamari-field-type="html">ZCCM-IH Office Park<br>Mass Media Area<br>Alick Nkhata Road, Lusaka Lusaka ZM, 10110</div>
										<a target="_blank" href="probasepay.com" class="katamari-field" data-katamari-field-id="9">probasepay.com</a>
										<div  class="contact">
											<a href="tel:+260974365365" class="katamari-field anchor" data-katamari-field-id="10" target=""><span>+260 974 365 365</span></a><br>
										</div>
									</div>
								</div>
								<div class="col col-xs-12 col-md-6 col-sm-12 col-lg-4" style="padding-top: 20px !important">
									<div class="office">
										<h6 class="katamari-field" data-katamari-field-id="8" data-katamari-field-type="html">Ndola</h6>
										<div  class="katamari-field address" data-katamari-field-id="99" data-katamari-field-type="html">ZCCM-IH Office Park<br>Mass Media Area<br>Alick Nkhata Road, Lusaka Lusaka ZM, 10110</div>
										<a target="_blank" href="probasepay.com" class="katamari-field" data-katamari-field-id="9">probasepay.com</a>
										<div  class="contact">
											<a href="tel:+260974365365" class="katamari-field anchor" data-katamari-field-id="10" target=""><span>+260 974 365 365</span></a><br>
					...
					<div class="col-xs-12 col-sm-12 col-lg-12 col-md-12" style="padding: 0px; padding-right: 10px; padding-top: 10px; ">
						<div class="col-xs-12 col-sm-12 col-lg-12 col-md-12">
						<h2 class="katamari-field" data-katamari-field-id="heading-1">Our Agents</h2>
							<div class="row">
								<div class="col col-xs-12 col-md-6 col-sm-12 col-lg-4" style="padding-top: 20px !important">
									<div class="office">
										<h6 class="katamari-field" data-katamari-field-id="8" data-katamari-field-type="html">Lusaka</h6>
