    ...
    <div class="ui-panel login-panel animated bounceInDown">
        <header>
            ...
            <div class="left logo" style="padding-top: 30px !important;">
                ...
                <a href="#logo"><span>Probase</span>Pay</a>
            </div>
        ...
        <form class="" method="post" id="login" action="/auth/app-otp-login">
            <div class="login-form" style="clear: both !important">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <input type="hidden" name="username" value="{{ $username }}">
                <input type="hidden" name="token" value="xfr">
                <input type="hidden" name="password" value="{{ $password }}">
                <input type="hidden" name="deviceVersion" id="deviceVersion" value="{{ $deviceVersion }}">
                <input type="hidden" name="deviceName" id="deviceName" value="{{ $deviceName }}">
                <input type="hidden" name="deviceKey" id="deviceKey" value="{{ $deviceKey }}">
                <input type="hidden" name="deviceAppId" id="deviceAppId" value="{{ $deviceAppId }}">
                <input type="hidden" name="deviceId" id="deviceId" value="{{ $deviceId }}">
                <input type="hidden" name="acquirerCode" id="acquirerCode" value="{{ $acquirerCode }}">
                <input type="hidden" name="isMobile" id="isMobile" value="0">
                <input type="hidden" name="autoAuthenticate" id="autoAuthenticate" value="1">





                <div class="subtitle"><strong>Enter the OTP sent to your mobile number</strong></div>

                <div class="row col-md-12 col-sm-12 col-lg-12">
                    <div class="col-md-3 col-sm-3 col-xs-3 col-lg-3" style="padding-left: 0px !important">
                        <input type="password" class="col-md-12 col-sm-12 col-lg-12 col-xs-12" name="otp1" id="otp1" placeholder="">
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-3 col-lg-3" style="padding-left: 0px !important">
                        <input type="password" class="col-md-12 col-sm-12 col-lg-12 col-xs-12" name="otp2" id="otp2" placeholder="">
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-3 col-lg-3" style="padding-left: 0px !important">
                        <input type="password" class="col-md-12 col-sm-12 col-lg-12 col-xs-12" name="otp3" id="otp3" placeholder="">
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-3 col-lg-3" style="padding-left: 0px !important">
                        <input type="password" class="col-md-12 col-sm-12 col-lg-12 col-xs-12" name="otp4" id="otp4" placeholder="">
                    </div>
                </div>
            </div>

            <footer style="padding-bottom: 50px !important;">
                <div class="left social-login">
                    <a href="#login" class="ui-button inactive login">Cancel</a>
                    <!--<a href="#login" class="ui-button inactive login"> | Resend OTP</a>-->
                </div>

                <div class="right form-actions">
                    <a onclick="loginAction()" style="cursor: pointer !important;" class="ui-button inactive register">Confirm My OTP</a>
                </div>
            </footer>
        </form>
    </div>
